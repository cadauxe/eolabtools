...
from test_utils import compare_files, clear_outdir, create_outdir, SunMapConfig
from eolabtools.sun_map_generation.SunMapGenerator import run, parser_return
