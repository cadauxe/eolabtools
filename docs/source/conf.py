...
# Title
html_title = "EOLabtools Documentation"
...
try:
    from eolabtools import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = "eolabtools-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "EOLabtools Documentation", "manual")
]
